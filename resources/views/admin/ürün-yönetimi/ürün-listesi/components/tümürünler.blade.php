<div class="row">
    <div class="content">
        <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
            ...
            <div>
                <a href="/productexport" class="btn btn-outline-success"> Exel Export</a>
                        ...
                        <div class="table-responsive">
                            <table id="responsive-data-table" class="table"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        @if ($products->r1)
                                        <td><img width="50" class="tbl-thumb" src="images/{{ $products->r1  }}" alt="Product Image" /></td>

                                        @else
                                        <td><img  width="50" class="tbl-thumb" src="images/resimyok.jpg" alt="Product Image" /></td>
                                        ...
                                        <td>
                                            <div class="btn-group mb-1">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item" onclick="confirm('Ürünü Silmek İstiyormusunuz')" href="{{ route("deleteproduct",$products->id) }}">Sil</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
