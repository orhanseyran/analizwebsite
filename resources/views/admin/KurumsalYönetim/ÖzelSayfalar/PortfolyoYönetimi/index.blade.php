					...
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						<div>
							...
							<p class="breadcrumbs"><span><a href="index.html">Ana Sayfa</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Portfolyo</p>
						</div>
						<div>
													...
													<td>
														<div class="btn-group mb-1">
															...
															<div class="dropdown-menu">
																...
																<a class="dropdown-item" onclick="return confirm('Bu Portfolyo silmek istediğinize emin misiniz?');" href="{{ route("ozelsayfa.sil",$get->id) }}">Delete</a>
                                                    ...
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content">
                                                          <div class="modal-header">
                                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Portfolyo Ekle</h1>
                                                          ...
                                                          <div class="modal-body">
                                                              ...
                                                              <div style="display:none" class="col-12 mt-5">
                                                                  ...
                                                                  <input type="text" name="sayfa_adi" class="form-control" value="Portfolyo" >
                                                              </div>
