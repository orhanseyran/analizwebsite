                ...
                <div class="row">
                    <div class="content">
                        <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                            <div>
                                <h1>Referanslarımız (Video)</h1>
                                <p class="breadcrumbs"><span><a href="index.html">Ana Sayfa</a></span>
                                    <span><i class="mdi mdi-chevron-right"></i></span> Referanslarımız</p>
                            </div>
                            <div>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#modal-add-member">Referabs Ekle
                                </button>
                            </div>
                        </div>
                                    ...
                                    <div class="card card-default">
                                        <div class="card-body text-center p-24px">
                                            <div class="image mb-3">
                                                ...
                                                @else
                                                <video width="150" height="150" src="{{ $get->içerik }}" controls ></video>

                                                {{-- <img src="images/{{ $get->resim }}" class="img-fluid rounded-circle" --}}
                                            ...
                                            <h5 class="card-title text-dark">Referans </h5>

                                            <a id="uyarı" onclick="return confirm('Bu Referans Videosunu silmek istediğinize emin misiniz?');" href="{{ route("ozelsayfa.sil",$get->id) }}"><span class="brand-delete mdi mdi-delete-outline"></span></a><br>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                <div class="modal-content">
                                    <form class="modal-header border-bottom-0" action="{{ route("ozelsayfa.ekle") }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <h2 class="mt-5 text-center">Referans Ekle</h2>
                                            <div class="col-12 mt-5">
                                                <div class="form-group">
                                                    <label for="Resim">Video  :</label>
                                                    <div class="input-group">
                                                        <span class="input-group-btn">
                                                          <a id="lfm1" data-input="thumbnail" data-preview="holder" class="btn btn-primary">
                                                            <i class="fa fa-picture-o"></i>Video Ekle
                                                          </a>
                                                        </span>
                                            ...
                                            <div style="display:none" class="col-12 mt-5">
                                                ...
                                                <input type="text" name="sayfa_adi" class="form-control" value="Referans" >
                                            </div>

                                            <div class="col-12 mt-5">
                                                <label for="file"> Yorum (Zorunlu Değil) </label>
                                                <textarea name="referans_yorum" class="form-control" id="summernote" name="içerik1" placeholder="Yorum"></textarea>
                                            </div>
                                            <div class="col-12 mt-5">
                                                <label for="file"> Şirket Adı Veya Kişi Adı (Zorunlu Değil)</label>
                                                <input type="text" name="referans_icerik" class="form-control" name="içerik2" placeholder="Şirket Adı Veya Kişi Adı">
                                            </div>
                                        ...
                                        <div class="modal-footer px-4">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-pill">Partner Ekle</button>
                                        </div>
