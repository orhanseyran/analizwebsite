                        ...
                        <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <p class="breadcrumbs"><span><a href="index.html">Ana Sayfa</a></span>
                                    <span><i class="mdi mdi-chevron-right"></i></span> Kargo</p>
                            </div>
                            <div>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#modal-add-member">Yeni Ekip Üyesi Ekle
                                </button>
                            </div>
                        </div>
                                    ...
                                    <div class="card card-default">
                                        <div class="card-body text-center p-24px">
                                            <div class="image mb-3">
                                                @if ($get->ekip_üye_icerik2 == null)
                                                <img src="kargo/kargo.jpeg" class="img-fluid rounded-circle"
                                                alt="Avatar Resmi">
                                                @else
                                                <img src="{{ $get->ekip_üye_icerik2 }}" class="img-fluid rounded-circle"
                                                alt="Avatar Resmi">
                                            ...
                                            <h5 class="card-title text-dark">{{ $get->ekip_üye_ad }} {{ $get->ekip_üye_icerik1 }} </h5> <br>
                                            <h5 class="card-title text-dark">{{ $get->ekip_üye_icerik3 }} </h5> <br>

                                            <a id="uyarı" onclick="return confirm('Bu Ekip Üyesini silmek istediğinize emin misiniz?');" href="{{ route("ozelsayfa.sil",$get->id) }}"><span class="brand-delete mdi mdi-delete-outline"></span></a><br>
                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                <div class="modal-content">
                                    <form class="modal-header border-bottom-0" action="{{ route("ozelsayfa.ekle") }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <h2 class="mt-5 text-center">Ekip Üyesi Ekle</h2>
                                            <div class="col-12 mt-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input id="thumbnail" class="form-control" name="ekip_üye_icerik2" type="text" name="filepath">
                                                      </div>
                                            ...
                                            <div style="display:none" class="col-12 mt-5">
                                                ...
                                                <input type="text" name="sayfa_adi" class="form-control" value="Ekip" placeholder="Ad">
                                            </div>
                                            <div class="col-12 mt-5">
                                                <label for="file"> Ad</label>
                                                <input type="text" name="ekip_üye_ad" class="form-control" placeholder="Ad">
                                            </div>
                                            <div class="col-12 mt-5">
                                                <label for="file"> Soyad</label>
                                                <input type="text" name="ekip_üye_icerik1" class="form-control" placeholder="Soyad">
                                            </div>
                                            <div class="col-12 mt-5">
                                                <label for="file"> Yetkisi</label>
                                                <input type="text" name="ekip_üye_icerik3" class="form-control" placeholder="Yetkisi">
                                            </div>
                                        ...
                                        <div class="modal-footer px-4">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-pill">Ekip Üyesi Ekle</button>
                                        </div>
