            ...
            <div style="width: 90%" class="container mt-5">
				<div class="content">
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						<div>
							<h1>Son 3 Gün Maç Analizleri</h1>
							<p class="breadcrumbs"><span><a href="index.html">Ana Sayfa</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Maç Analizleri</p>
						</div>
						{{-- <div>
													...
													<td>
														<div class="btn-group mb-1">
															...
															<div class="dropdown-menu">
																...
																<a class="dropdown-item" onclick="confirm('Tahmini Silmek İstiyormusunuz')" href="{{ route("blog.delete",$get->id) }}">Sil</a>
															</div>
														</div>
													</td>
                                                    <div class="modal fade" id="exampleModal{{ $get->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <form action="{{ route("editMacAnaliz",$get->id) }}" method="POST" >
                                                            @csrf
                                                        <div class="modal-dialog modal-xl">
                                                          <div class="modal-content">
                                                            <div class="modal-header">
                                                              <h1 class="modal-title fs-5" id="exampleModalLabel">Analiz Düzenle</h1>
                                                            ...
                                                            <div class="modal-body p-5">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="mb-3">
                                                                            <label for="exampleInputEmail1" class="form-label">Analiz</label>
                                                                            @foreach ($tahmin as $settahmin  )
                                                                            @if ( $settahmin["tahmin_id"] == $get->id)

                                                                            <textarea id="summernote{{ $get->id }}" name="tahmin"  >{!! $settahmin["tahmin"] !!}</textarea>
