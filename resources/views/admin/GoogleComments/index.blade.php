			...
			<div class="row">
				<div  style="width: 90%" class="container mt-5">
					<div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							<h1 class="text-center">Google Yorumlar Entegrasyonu</h1>
                    ...
                    <div class="container-fluid">
                        <div class="row  ">
                           ...
                           <form method="POST" action="{{ route("GoogleCommentsadd") }}">
                               @csrf
                               <div class="row">
                                   <div class="col-md-6  mb-3">
                                       <label for="exampleInputEmail1" class="form-label">Script Kodunuz</label>
                                       <input type="text" class="form-control" name="script_code" value="{{ $googleComments->script_code ?? "" }}" id="exampleInputEmail1" required>
                                       <div id="emailHelp" style="font-size:16px" class="form-text">Google Yorumlar Entegrasyon Yapmak İçin <a href="https://trustmary.com/">Üye Olun</a> Size Verilen Script Kodunu İlgili Alana Yapıştırın</div>
                                     </div>

                                     <div class="col-md-6">
                                        <h3 class="mb-3">Nasıl Yapılır</h3>
                                        <video width="100%" src="Google.mp4" autoplay controls></video>
                                     </div>
