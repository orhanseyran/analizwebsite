					...
					<div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
						<div>
							...
							<p class="breadcrumbs"><span><a href="index.html">Ana Sayfa</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Kullanıcılar</p>
						</div>
						<div>
									...
									<div class="table-responsive">
										<table id="responsive-data-table" class="table"
											...
											<tbody>
                                                ...
                                                <tr>
													<td><img class="tbl-thumb" src="{{ $get["avatar_urls"][48]}}" alt="{{ $get["avatar_urls"][48]}}" /></td>
													<td>{{ $get["name"]}}</td>
													<td>{{ $get["description"] == "" ?"Açıklama Yok" : $get["description"] }}</td>
													<td> <a href="{{ $get["link"] }}">Kategori Linki</a></td>
													<td>{{ $get["slug"]}}</td>
													<td>{{ $get["id"]}}</td>
													<td>{{ $get["is_super_admin"] == false ? "Süper admin değil" : "Süper Admin"}}</td>
