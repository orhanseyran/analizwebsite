...
<body>
    ...
    <div  class="layout-wrapper layout-navbar-full layout-horizontal layout-without-menu">
		...
		<div class="row">
            ...
            <form action="{{ route("indexdestekolustur") }}" method="post">
                @csrf
                        ...
                        <div  class="col-md-8 mx-auto border-5">
                            ...
                            <div class="bg-white p-3 shadow rounded">
                                <div class="row mb-5 bg-success p-4 ">
                                    <div class="col-md-6">
                                        <h3 style="color: #fff" >Destek Talebi Oluştur </h3>
                                    </div>
                                    {{-- <div class="col-md-6">
                                ...
                                {{-- <select required  name="durum" class="form-select mb-3" aria-label="Default select example">
                                ...
                                <select required name="öncelik" class="form-select mb-3" aria-label="Default select example">
                                ...
                                <select required name="konu" class="form-select mb-3" aria-label="Default select example">
                                ...
                                <input required name="baslik" type="text" value="Başlık" class="form-control mb-3" />
                                ...
                                <div class="chat-box mt-5">
                                    ...
                                    {{-- <div>
                                        ...
                                        <div class="chat-message sent">
                                            Merhaba, ürünlerinizle ilgili bilgi almak istiyorum.
                                            <p style="font-size:12px" class="text-end pt-3">Orhan Seyran(Müşteri)</p>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="chat-message received">
                                            Tabii, hangi ürünlerimiz hakkında daha fazla bilgi almak istersiniz?
                                            <p style="font-size:12px" class="text-end pt-3">Orhan Seyran(Müşteri-Destek)</p>
                                        </div>
                                    </div> --}}
                                ...
                                <div class="input-group mt-3">
                                    <input required type="text" name="mesaj" class="form-control chat-input" placeholder="Mesajınızı yazınız...">
