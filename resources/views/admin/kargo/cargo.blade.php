                    ...
                    <div class="content">
                        <div class="breadcrumb-wrapper d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                    data-bs-target="#modal-add-member">Kargo Ekle
                                </button>
                            </div>
                        </div>
                                    ...
                                    <div class="card card-default">
                                        <div class="card-body text-center p-24px">
                                            <div class="image mb-3">
                                                ...
                                                alt="Avatar Resmi">
                                                @else
                                                <img src="images/{{ $Kargo->resim }}" class="img-fluid rounded-circle"
                                                alt="Avatar Resmi">
                                            ...
                                            <h5 class="card-title text-dark">{{ $Kargo->kargo_adi }} </h5>

                                            <a id="uyarı" onclick="return confirm('Bu Kargoyı silmek istediğinize emin misiniz?');" href="{{ route("kargo.sil",$Kargo->id) }}"><span class="brand-delete mdi mdi-delete-outline"></span></a><br>
                        ...
                        <div class="modal fade" id="modal-add-member" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
                                <div class="modal-content">
                                    <form class="modal-header border-bottom-0" action="{{ route("kargo.ekle") }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            <h2 class="mt-5 text-center">Kargo Ekle</h2>
                                            <div class="col-12 mt-5">
                                                <label for="file"> Resim</label>
                                                <input type="file" name="resim" class="form-control" placeholder="Resim">
                                            </div>
                                            <div class="col-12 mt-5">
                                                <label for="file"> Kargo Adı</label>
                                                <input type="text" name="kargo_adi" class="form-control" placeholder="Kargo Adı">
                                            </div>
                                        ...
                                        <div class="modal-footer px-4">
                                            ...
                                            <button type="submit" class="btn btn-primary btn-pill">Kargo Ekle</button>
                                        </div>
