                        ...
                        <div class="rbt-header-content justify-content-start justify-content-xl-center">
                            <div class="header-info">
                                <div class="rbt-header-top-news">
                                    <div class="inner">
                                        <div class="content">
                                            <span class="news-text"><img src="assets2/images/icons/hand-emojji.svg" alt="Hand Emojji Images"> Şimdi Analiz Satın Al Geçersiz Analizler İade.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="mainbar-row rbt-navigation-center align-items-center">
                <div class="header-left rbt-header-content">
                    <div class="header-info">
                        <div class="logo">
                            <a href="/">
                                <img width="350" src="logo.png" alt="Education Logo Images">
                            </a>
                        </div>
                    </div>
                ...
                <div class="rbt-main-navigation d-none d-xl-block">
                    <nav class="mainmenu-nav">
                        <ul class="mainmenu">
                            ...
                            <li class="with-megamenu has-menu-child-item position-static">
                                <a href="/analizler">Analizciler </a>
                                <!-- Start Mega Menu  -->

                                <!-- End Mega Menu  -->
                            </li>
                            <li class="with-megamenu has-menu-child-item position-static">
                                <a href="/maçlar"> Maç Analizleri </a>
                                <!-- Start Mega Menu  -->
                                            ...
                                            <div class="col-lg-12 col-xl-3 col-xxl-3 single-mega-item">
                                                <div class="mega-category-item">
                                                    ...
                                                    <div class="nav-category-item">
                                                        <div class="thumbnail">
                                                            <div class="image"><img src="assets2/images/course/category-2.png" alt="Course images"></div>
                                                    ...
                                                    <div class="nav-category-item">
                                                        <div class="thumbnail">
                                                            <div class="image"><img src="assets2/images/course/category-1.png" alt="Course images"></div>
                                                            <a href="course-filter-one-toggle.html">
                                                    ...
                                                    <div class="nav-category-item">
                                                        <div class="thumbnail">
                                                            <div class="image"><img src="assets2/images/course/category-4.png" alt="Course images"></div>
                                                            <a href="course-filter-one-toggle.html">
                                                    ...
                                                    <div class="nav-category-item">
                                                        <div class="thumbnail">
                                                            <div class="image"><img src="assets2/images/course/category-9.png" alt="Course images"></div>
                                                            <a href="course-filter-one-toggle.html">
                                                                <span>Academy</span>
                                                                <i class="feather-chevron-right"></i>
                                                            </a>
                                        ...
                                        <div class="row row--15">
                                            ...
                                            <div class="col-lg-12 col-xl-4 col-xxl-4 single-mega-item">
                                                <div class="rbt-ads-wrapper">
                                                    <a class="d-block" href="#"><img src="assets2/images/service/mobile-cat.jpg" alt="Education Images"></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        line-height: initial;
                ...
                <div class="header-right">
                    ...
                    <ul class="quick-access">
                        {{-- <li class="access-icon d-none d-md-block">
                            <a class="search-trigger-active rbt-round-btn" href="#">
                                <i class="feather-search"></i>
                            </a>
                        </li> --}}
                        @if (Auth::check())
                        <li class="access-icon rbt-mini-cart d-none d-xl-block mx-5">
                            <a class=" rbt-round-btn" href="{{ route("Jetonlar") }}" aria-label="Cart">
                                ...
                                <span class="rbt-cart-count mx-2" aria-label="Cart count">{{ $tokenget }} Jeton</span>
                            </a>
                        </li>
                        @endif
                        ...
                        <li class="account-access rbt-user-wrapper d-none d-xl-block">
                            <a href="/login-user"><i class="feather-user"></i> Giriş Yap </a>

                        </li>

                        @else
                        <li class="account-access rbt-user-wrapper d-none d-xl-block">
                            <a href="/musteri"><i class="feather-user"></i> Panelim </a>
                            <div class="rbt-user-menu-list-wrapper">
                                <div class="inner">
                                    <div class="rbt-admin-profile">
                                        <div class="admin-thumbnail">
                                            <img src="assets2/images/team/avatar.jpg" alt="User Images">
                                        </div>
                    ...
                    <div class="rbt-btn-wrapper d-none d-xl-block">
                        <a class="rbt-btn rbt-marquee-btn marquee-auto btn-border-gradient radius-round btn-sm hover-transform-none" href="#">
                            <span data-text="Şimdi Analiz Satın Al">Şimdi Analiz Satın Al</span>
                        </a>
                    </div>
        ...
        <div class="inner-wrapper">
            <div class="inner-top">
                <div class="content">
                    <div class="logo">
                        <a href="index.html">
                            <img src="assets2/images/logo/logo.png" alt="Education Logo Images">
                        </a>
                    </div>
                    <div class="rbt-btn-close">
                                ...
                                <div class="row row--15 home-plesentation-wrapper single-dropdown-menu-presentation">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="01-main-demo.html"><img src="assets2/images/splash/demo/h1.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="12-marketplace.html"><img src="assets2/images/splash/demo/h12.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="04-kindergarten.html"><img src="assets2/images/splash/demo/h4.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="13-university-classic.html"><img src="assets2/images/splash/demo/h13.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="14-home-elegant.html"><img src="assets2/images/splash/demo/h14.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="09-gym-coaching.html"><img src="assets2/images/splash/demo/h9.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="03-online-school.html"><img src="assets2/images/splash/demo/h3.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="06-university-status.html"><img src="assets2/images/splash/demo/h6.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="15-home-technology.html"><img src="assets2/images/splash/demo/h15.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="07-instructor-portfolio.html"><img src="assets2/images/splash/demo/h7.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="08-language-academy.html"><img src="assets2/images/splash/demo/h8.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="11-single-course.html"><img src="assets2/images/splash/demo/h11.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="10-online-course.html"><img src="assets2/images/splash/demo/h10.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="05-classic-lms.html"><img src="assets2/images/splash/demo/h5.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="02-course-school.html"><img src="assets2/images/splash/demo/h2.jpg" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item coming-soon">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="#"><img src="assets2/images/splash/demo/coming-soon-1.png" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item coming-soon">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="#"><img src="assets2/images/splash/demo/coming-soon-2.png" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
                                    ...
                                    <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item coming-soon">
                                        <div class="demo-single">
                                            <div class="inner">
                                                <div class="thumbnail">
                                                    <a href="#"><img src="assets2/images/splash/demo/coming-soon-3.png" alt="Demo Images"></a>
                                                </div>
                                                <div class="content">
            ...
            <nav class="side-nav w-100">
                <ul class="rbt-minicart-wrapper">
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="assets2/images/product/1.jpg" alt="Product Images">
                            </a>
                        </div>
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="assets2/images/product/7.jpg" alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="assets2/images/product/3.jpg" alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
                    ...
                    <li class="minicart-item">
                        <div class="thumbnail">
                            <a href="#">
                                <img src="assets2/images/product/4.jpg" alt="Product Images">
                            </a>
                        </div>
                        <div class="product-content">
