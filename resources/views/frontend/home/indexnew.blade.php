    ...
    <main class="rbt-main-wrapper">
                        ...
                        <div class="content">
                            <div class="inner">
                                <div class="rbt-new-badge rbt-new-badge-one">
                                    <span class="rbt-new-badge-icon">⚽</span> En Güvenilir İddaa Analiz Platformu
                                </div>

                                <h1 class="title">
                                    Doğru Tahminlerle <br> Kazanmaya Başlayın.
                                </h1>
                                <p class="description">
                                    Bahis dünyasında kazanmak için ihtiyacınız olan <strong>en iyi analizler</strong> ve stratejiler burada.
                                    <br> Analizlerimizden memnun kalmazsanız <strong>para iade garantisi!</strong>
                                </p>
                                <div class="slider-btn">
                                    <a class="rbt-btn btn-gradient hover-icon-reverse" href="#">
                                        <span class="icon-reverse-wrapper">
                                            <span class="btn-text">Analizleri İncele</span>
                            ...
                            <div class="shape-wrapper" id="scene">
                                ...
                                {{-- <div class="hero-bg-shape-2 layer" data-depth="0.4">
                                    <img src="assets2/images/shape/shape-02.png" alt="Hero Image Background Shape">
                                </div> --}}
                            </div>
                            ...
                            <div class="banner-card pb--60 mb--50 swiper rbt-dot-bottom-center banner-swiper-active">
                                <div class="swiper-wrapper">
                                    ...
                                    <!-- Start Single Card  -->
                                    @foreach ($kuponlar as  $get)
                                    <div class="swiper-slide">
                                        <div class="rbt-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="course-details.html">
                                                    <img src="user.png" alt="Card image">                                                    <div class="rbt-badge-3 bg-white">
                                                        <span>%90</span>
                                                        <span>Başarı</span>
                                                    </div>
                                                </a>
                                            ...
                                            <div class="rbt-card-body">
                                                <h4 class="rbt-card-title"><a href="analiz-detay.html">{{ $get->name }}</a></h4>
                                                <p class="rbt-card-text">{{ $get->description }}.</p>
                                                <div class="rbt-card-bottom">
                                                    <div class="rbt-price">
                                                        <span class="current-price">{{ $get->token }} Jeton</span>
                                                    </div>
                                                    <a class="rbt-btn-link" href="{{ route("analizdetay",$get->id) }}">Daha Fazla<i
                ...
                <div class="row g-5 mt--20">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="assets2/images/category/web-design.png" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="assets2/images/category/design.png" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="assets2/images/category/personal.png" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="assets2/images/category/server.png" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="assets2/images/category/pantone.png" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="assets2/images/category/paint-palette.png" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="assets2/images/category/smartphone.png" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                        <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.html">
                            <div class="inner">
                                <div class="icons">
                                    <img src="assets2/images/category/infographic.png" alt="Icons Images">
                                </div>
                                <div class="content">
        ...
        <div class="rbt-course-area bg-color-extra2 rbt-section-gap">
            <div class="container">
                <div class="row mb--60">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            <span class="subtitle bg-secondary-opacity"> Manşette Olan Analizler</span>
                            <h2 class="title">Günün En Çok Satan Analizleri</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="row g-5">
                            ...
                            <div class="rbt-card-body">
                                <div class="rbt-card-top">
                                    <div class="rbt-review">
                                        ...
                                        <span class="rating-count"> (15 Değerlendirme)</span>
                                    </div>
                                    <div class="rbt-bookmark-btn">
                                        <a class="rbt-round-btn" title="Kaydet" href="#"><i class="feather-bookmark"></i></a>
                                    </div>
                                </div>

                                <h4 class="rbt-card-title"><a href="analysis-details.html">Galatasaray vs Fenerbahçe</a>
                                </h4>
                                <ul class="rbt-meta">
                                    <li><i class="feather-book"></i>20 Tahmin</li>
                                    <li><i class="feather-users"></i>40 Kullanıcı</li>
                                </ul>
                                <p class="rbt-card-text">Son maç verilerine dayanan detaylı analizlerle kazanın.</p>
                                <div class="rbt-author-meta mb--20">
                                    <div class="rbt-avater">
                                        <a href="#">
                                            <img src="assets2/images/client/avater-01.png" alt="Sophia Jaymes">
                                        </a>
                                    </div>
                                    <div class="rbt-author-info">
                                        Hazırlayan <a href="profile.html">Patrick</a> İçerik <a href="#">Futbol</a>
                                    </div>
                                </div>
                                ...
                                <div class="rbt-card-bottom">
                                    ...
                                    <a class="rbt-btn-link" href="analysis-details.html">Daha Fazla<i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-card variation-01 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="analysis-details.html">
                                    <img  height="100" src="user.png" alt="Card image">
                                    {{-- <div class="rbt-badge-3 bg-white">
                                        <span>%35</span>
                                        <span>Fırsat</span>
                                    </div> --}}
                            ...
                            <div class="rbt-card-body">
                                <div class="rbt-card-top">
                                    <div class="rbt-review">
                                        ...
                                        <span class="rating-count"> (12 Değerlendirme)</span>
                                    </div>
                                    <div class="rbt-bookmark-btn">
                                        <a class="rbt-round-btn" title="Kaydet" href="#"><i class="feather-bookmark"></i></a>
                                    </div>
                                </div>
                                <h4 class="rbt-card-title"><a href="analysis-details.html">Ben Sizin İçin Premier Lig Günün Maçlarının Analizini Yaparım</a>
                                </h4>
                                <ul class="rbt-meta">
                                    <li><i class="feather-book"></i>10 Tahmin</li>
                                    <li><i class="feather-users"></i>25 Kullanıcı</li>
                                </ul>
                                <p class="rbt-card-text">Son verilerle hazırlanmış özelleştirilmiş analizler.</p>

                                <div class="rbt-author-meta mb--20">
                                    <div class="rbt-avater">
                                        <a href="#">
                                            <img src="assets2/images/client/avatar-03.png" alt="Sophia Jaymes">
                                        </a>
                                    </div>
                                    <div class="rbt-author-info">
                                        Hazırlayan <a href="profile.html">Slaughter</a> İçerik <a href="#">Futbol</a>
                                    </div>
                                </div>
                                <div class="rbt-card-bottom">
                                    <div class="rbt-price">
                                        <span class="current-price">70₺</span>
                                        <span class="off-price">110₺</span>
                                    </div>
                                    <a class="rbt-btn-link" href="analysis-details.html">Daha Fazla<i class="feather-arrow-right"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <h4 class="rbt-card-title"><a href="analysis-details.html">Ben Sizin İçin Laliga Günün Maçlarının Analizini Yaparım</a>
                                </h4>
                                <ul class="rbt-meta">
                                    <li><i class="feather-book"></i>10 Tahmin</li>
                                    <li><i class="feather-users"></i>25 Kullanıcı</li>
                    ...
                    <div class="col-lg-12">
                        <div class="load-more-btn mt--60 text-center">
                            <a class="rbt-btn btn-gradient btn-lg hover-icon-reverse" href="#">
                                <span class="icon-reverse-wrapper">
                                    <span class="btn-text">Daha Fazla Analiz Yükle (40)</span>
                                <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                                <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                                </span>
                            </a>
        ...
        <div class="rbt-event-area rbt-section-gap bg-gradient-3">
            <div class="container">
                <div class="row mb--55">
                    <div class="section-title text-center">
                        <span class="subtitle bg-white-opacity">Bu Ayın En Başarılıları ?</span>
                        <h2 class="title color-white">En Başarılı Analizciler</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                                        ...
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="event-details.html">
                                                    <img src="assets2/images/event/grid-type-02.jpg" alt="Card image">
                                                    <div class="rbt-badge-3 bg-white">
                                                        <span>11 Mar</span>
                                                        <span>2023</span>
                                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="single-slide">
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="event-details.html">
                                                    <img src="assets2/images/event/grid-type-04.jpg" alt="Card image">
                                                    <div class="rbt-badge-3 bg-white">
                                                        <span>11 Jan</span>
                                                        <span>2023</span>
                                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="single-slide">
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="event-details.html">
                                                    <img src="assets2/images/event/grid-type-05.jpg" alt="Card image">
                                                    <div class="rbt-badge-3 bg-white">
                                                        <span>11 Mar</span>
                                                        <span>2023</span>
                                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="single-slide">
                                        <div class="rbt-card event-grid-card variation-01 rbt-hover">
                                            <div class="rbt-card-img">
                                                <a href="event-details.html">
                                                    <img src="assets2/images/event/grid-type-01.jpg" alt="Card image">
                                                    <div class="rbt-badge-3 bg-white">
                                                        <span>11 Jan</span>
                                                        <span>2023</span>
                                                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="thumbnail-wrapper">
                            <div class="thumbnail image-1">
                                <img data-parallax='{"x": 0, "y": -20}' src="banner4.png" alt="Analiz Satış">
                            </div>
                            {{-- <div class="thumbnail image-2 d-none d-xl-block">
                                <img data-parallax='{"x": 0, "y": 60}' src="banner4.png" alt="Analiz Satış">
                            </div> --}}
                            <div class="thumbnail image-3 d-none d-md-block">
                                <img data-parallax='{"x": 0, "y": 80}' src="banner3.png" alt="Analiz Satış">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="inner pl--50 pl_sm--0 pl_md--0">
                            <div class="section-title text-start">
                                ...
                                <h2 class="title">İddaa Analiz Platformunu <br /> Daha Yakından Tanıyın</h2>
                            </div>

                            <p class="description mt--30">Futbol ve diğer spor dallarına yönelik en güvenilir analizleri sunan platformumuz, kullanıcılarına kazandırmayı hedefliyor. İstatistikler ve profesyonel tahminler ile başarıya ulaşın.</p>
                            <p>Bu Sistemde Bahis Oynatmaya Yönelik Bir Çalışma Yoktur Sadece Analiz Paylaşımı Yapılır</p>
                            ...
                            <div class="rbt-feature-wrapper mt--20 ml_dec_20">
                                <div class="rbt-feature feature-style-2 rbt-radius">
                                    ...
                                    <div class="feature-content">
                                        <h6 class="feature-title">Esnek Analiz Paketleri</h6>
                                        <p class="feature-description">En Başarılı analizcinizi seçerek kazancınızı artırabilirsiniz.</p>
                                    </div>
                                </div>
                                ...
                                <div class="rbt-feature feature-style-2 rbt-radius">
                                    ...
                                    <div class="feature-content">
                                        <h6 class="feature-title">Her Yerden Erişim</h6>
                                        <p class="feature-description">Mobil veya masaüstü cihazlarınızdan analizlerimize kolayca ulaşabilirsiniz.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-12 col-xl-7">
                                    <div class="video-popup-wrapper mt_lg--10 mt_md--20 mt_sm--20">
                                        <img class="w-100 rbt-radius" src="assets2/images/others/video-01.jpg" alt="Video Images">
                ...
                <div class="row mb--60">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            ...
                            <h2 class="title">Nasıl Çalışıyor</h2>
                        </div>
                    </div>
                </div>
                <div class="row g-5 hanger-line">
                        ...
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                <div class="rbt-round-icon">
                                    <img src="assets2/images/icons/counter-01.png" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--60 mt_md--30 mt_sm--30 mt_mobile--60">
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                <div class="rbt-round-icon">
                                    <img src="assets2/images/icons/counter-02.png" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt_md--60 mt_sm--60">
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                <div class="rbt-round-icon">
                                    <img src="assets2/images/icons/counter-03.png" alt="Icons Images">
                                </div>
                                <div class="content">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--60 mt_md--30 mt_sm--30 mt_mobile--60">
                        <div class="rbt-counterup rbt-hover-03 border-bottom-gradient">
                            ...
                            <div class="inner">
                                <div class="rbt-round-icon">
                                    <img src="assets2/images/icons/counter-04.png" alt="Icons Images">
                                </div>
                                <div class="content">
                ...
                <div class="scroll-animation scroll-right-left">
                        ...
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                <div class="description">
                                    <p class="subtitle-3">"Bu site sayesinde analizlerim çok daha başarılı oldu. Kazançlarım arttı, tavsiye ederim!"</p>
                                    <div class="client-info">
                                        <h5 class="title">Ahmet K., <span>Analizci</span></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                <div class="description">
                                    <p class="subtitle-3">"Site üzerindeki önerilerle büyük kazançlar elde ettim. Kullanımı kolay ve çok faydalı!"</p>
                                    <div class="client-info">
                                        <h5 class="title">Elif Y., <span>İddaa Oyuncusu</span></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                <div class="description">
                                    <p class="subtitle-3">"Analizler oldukça isabetli ve güncel. Buradan öğrendiğim bilgilerle daha doğru tahminler yapabiliyorum."</p>
                                    <div class="client-info">
                                        <h5 class="title">Murat T., <span>Bahis Sever</span></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                <div class="description">
                                    <p class="subtitle-3">"Kullanıcı dostu bir tasarımı var. İstatistikler oldukça faydalı ve doğru tahminler yapmamı sağladı."</p>
                                    <div class="client-info">
                                        <h5 class="title">Ayşe B., <span>Analiz Uzmanı</span></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="single-column-20 bg-theme-gradient-odd">
                        <div class="rbt-testimonial-box style-2">
                            <div class="inner">
                                <div class="description">
                                    <p class="subtitle-3">"Bahis analizleriyle dolu harika bir platform. Tahminlerimdeki başarı oranım ciddi şekilde arttı."</p>
                                    <div class="client-info">
                                        <h5 class="title">Ali G., <span>Stratejist</span></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="rbt-team-tab-content tab-content" id="myTabContent">
                            <div class="tab-pane fade active show" id="team-tab1" role="tabpanel" aria-labelledby="team-tab1-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets2/images/team/team-01.jpg" alt="Testimonial Images">
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="team-tab2" role="tabpanel" aria-labelledby="team-tab2-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets2/images/team/team-02.jpg" alt="Testimonial Images">
                                        </div>
                                    </div>
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                            ...
                            <div class="tab-pane fade" id="team-tab3" role="tabpanel" aria-labelledby="team-tab3-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets2/images/team/team-03.jpg" alt="Testimonial Images">
                                        </div>
                                    </div>
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                            ...
                            <div class="tab-pane fade" id="team-tab4" role="tabpanel" aria-labelledby="team-tab4-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets2/images/team/team-04.jpg" alt="Testimonial Images">
                                        </div>
                                    </div>
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                            ...
                            <div class="tab-pane fade" id="team-tab5" role="tabpanel" aria-labelledby="team-tab5-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets2/images/team/team-05.jpg" alt="Testimonial Images">
                                        </div>
                                    </div>
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                            ...
                            <div class="tab-pane fade" id="team-tab6" role="tabpanel" aria-labelledby="team-tab6-tab">
                                <div class="inner">
                                    <div class="rbt-team-thumbnail">
                                        <div class="thumb">
                                            <img src="assets2/images/team/team-06.jpg" alt="Testimonial Images">
                                        </div>
                                    </div>
                                    <div class="rbt-team-details">
                                        <div class="author-info">
                ...
                <div class="row row--15">
                        ...
                        <div class="rbt-card variation-02 height-330 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="blog-details.html">
                                    <img src="assets2/images/blog/blog-card-01.jpg" alt="Card image"> </a>
                            </div>
                            <div class="rbt-card-body">
                    ...
                    <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt--30" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        ...
                        <div class="rbt-card card-list variation-02 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="blog-details.html">
                                    <img src="assets2/images/blog/blog-card-02.jpg" alt="Card image"> </a>
                            </div>
                            <div class="rbt-card-body">
                        ...
                        <div class="rbt-card card-list variation-02 rbt-hover mt--30">
                            <div class="rbt-card-img">
                                <a href="blog-details.html">
                                    <img src="assets2/images/blog/blog-card-03.jpg" alt="Card image"> </a>
                            </div>
                            <div class="rbt-card-body">
                        ...
                        <div class="rbt-card card-list variation-02 rbt-hover mt--30">
                            <div class="rbt-card-img">
                                <a href="blog-details.html">
                                    <img src="assets2/images/blog/blog-card-04.jpg" alt="Card image"> </a>
                            </div>
                            <div class="rbt-card-body">
