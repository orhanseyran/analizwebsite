        ...
        <div class="right-sidebar-container-2">
          <div class="slim-scroll-right-sidebar-2">
            ...
            <div class="right-sidebar-2-body" data-simplebar>
              ...
              <span class="right-sidebar-2-subtitle">Header Arka Plan</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active ec-header-light-to">Gündüz</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 ec-header-dark-to">Gece</a>
              </div>


              <span class="right-sidebar-2-subtitle">Özel Görünüm</span>
              <div class="no-col-space">
                <a href="javascript:void(0);" class="btn-right-sidebar-2 btn-right-sidebar-2-active default-spacing-to">Varsayılan</a>
                <a href="javascript:void(0);" class="btn-right-sidebar-2 compact-spacing-to">Kompakt</a>
              </div>
              <div class="d-flex justify-content-center">
                <div id="reset-options" style="width: auto; cursor: pointer" class="btn-right-sidebar-2 btn-reset">Ayarları Sıfırla</div>
              </div>
            </div>
          </div>
        </div>
